...
# 362 "/usr/include/bits/fcntl-linux.h" 3 4

# 436 "/usr/include/bits/fcntl-linux.h" 3 4
...
# 1 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stddef.h" 1 3 4
# 216 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stddef.h" 3 4
...
# 1 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stdarg.h" 1 3 4
# 40 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stdarg.h" 3 4
...
# 4 "upper-half-mpi-wrappers.c" 2
# 1 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stdint.h" 1 3 4
# 9 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stdint.h" 3 4
...
# 10 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stdint.h" 2 3 4
# 5 "upper-half-mpi-wrappers.c" 2
...
# 1 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stddef.h" 1 3 4
# 328 "/usr/lib64/gcc/x86_64-suse-linux/8/include/stddef.h" 3 4
typedef int wchar_t;
...
# 115 "/usr/include/bits/mman-linux.h" 3 4
# 1 "/usr/include/bits/mman-shared.h" 1 3 4
# 115 "/usr/include/bits/mman-linux.h" 2 3 4
...
# 12 "upper-half-mpi-wrappers.c" 2
...
# 1793 "/usr/include/elf.h" 3 4
typedef struct
{
  Elf32_Word hwp_flags1;
  Elf32_Word hwp_flags2;
} Elf_Options_Hw;
# 1959 "/usr/include/elf.h" 3 4
typedef struct
{
  Elf32_Word l_name;
...
# 68 "/usr/include/bits/link.h" 3 4
...
# 13 "/usr/include/asm/unistd.h" 3 4
# 1 "/usr/include/asm/unistd_64.h" 1 3 4
# 14 "/usr/include/asm/unistd.h" 2 3 4
...
# 26 "common.h"
static const char *colors[] = {"\x1B[0m", "\x1B[31m", "\x1B[34m", "\x1B[32m"};
# 43 "common.h"
typedef char* VA;
...
typedef enum __MPI_Fncs {
  MPI_Fnc_NULL,
  MPI_Fnc_Init, MPI_Fnc_Comm_rank, MPI_Fnc_Send, MPI_Fnc_Recv,
  MPI_Fnc_Invalid,
} MPI_Fncs_t;

void* lhDlsym(MPI_Fncs_t type);
typedef void* (*LhDlsym_t)(MPI_Fncs_t type);


MmapInfo_t* getMmappedList(int *num);
typedef MmapInfo_t* (*GetMmappedListFptr_t)(int *num);
# 14 "upper-half-mpi-wrappers.c" 2
# 1 "upper-half-wrappers.h" 1
...
# 15 "upper-half-mpi-wrappers.c" 2
# 1 "upper-half-mpi-wrappers.h" 1
# 16 "upper-half-mpi-wrappers.c" 2
# 24 "upper-half-mpi-wrappers.c"
EXTERNC int MPI_Comm_rank(int group, int * world_rank) { int retval; return retval; }
